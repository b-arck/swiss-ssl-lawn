...
C<use GetCertDetails qw(check_protocol_cipher);>

C<$cert_details = get_cert_details( $host, $port );>

=head1 DESCRIPTION

This module get the host certificate and extract all informations.

=head2 Extracted data
...
Certificate, signature and public key info
